...
export default function ProjectDetailPage() {
  ...
  const allProjectIds = Object.keys(projectsData).filter((pid) => pid !== id)
  const randomIds = allProjectIds.sort(() => 0.5 - Math.random()).slice(0, 3)
  const relatedProjects = randomIds.map((pid) => ({
    id: pid,
    ...projectsData[pid as keyof typeof projectsData],
  }))
